<template>
  <el-scrollbar class="el-scrollbar">
    <el-menu class="el-menu-slide" :defaut-active="$router.currentRoute.path" router>
      <template
      ...
      >
        ...
        <el-submenu v-else :index="item.children[0].path" :key="item.name">
          <template slot="title">
            ...
            <span slot="title" v-if="item.meta&&item.meta.title">{{item.children[0].meta.title}}</span>
          </template>
